...
Microchip mpfs_discokit
#####################

Overview
********

The Microchip mpfs_discokit board is a PolarFire SoC FPGA based development board with a Microchip MPFS095T fpga device.
The E51 RISC-V CPU can be deployed on the mpfs_icicle board.
More information can be found on the `Microchip website <https://www.microchip.com/en-us/product/MPFS095T>`_.
...
Applications for the ``mpfs_discokit`` board configuration can be built as usual
